...
class ChatAgent:
    SYSTEM_PROMPT = (
        ...
        "If you lack a native tool for a request consider using the template rendering tool,"
        "However, if you do use the rendering tool then let the user know if there was a better way"
        "When you call a tool ALWAYS include a text response that explains what you are doing."
    ...
    def build_agent(
        ...
        return Agent(
            ...
            tools=[
                ...
                Tool(ha_search_services, requires_approval=False),
                ...
                Tool(search_entities, requires_approval=False),
